...
@section('content')
	<div class="section-top-banner servicios">
		<div class="container">
			<p class="asap">Estamos <br>para servirte</p>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-sm-6 service-item">
				<div class="icon-service"><img src="images/servicio-door-to-door.svg" alt=""></div>
		...
		<div class="row">
			...
			<div class="col-sm-6 service-item">
				<div class="icon-service"><img src="images/servicio-seguridad.svg" alt=""></div>
		...
		<div class="row">
			...
			<div class="col-sm-6 service-item">
				<div class="icon-service"><img src="images/servicio-maniobras-carga-descarga.svg" alt=""></div>
		...
		<div class="row">
			...
			<div class="col-sm-6 service-item">
				<div class="icon-service"><img src="images/servicio-rastreo-satelital.svg" alt=""></div>
